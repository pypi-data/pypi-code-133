...
from ..routerlib import RegistrationHandler
from ..routerlib import BbgBDPHandler, BbgBDHHandler
from ..routerlib import OpenfigiSearchHandler
...
def run(port=None, logging_config_file=None):
    ...
    handlers = [
        ...
        (r"/openfigi/search", OpenfigiSearchHandler)
    ]
